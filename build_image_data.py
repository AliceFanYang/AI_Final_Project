...
where we have selected 1 and 1 shards for each data set. Each record
within the TFRecord file is a serialized Example proto. The Example proto
contains the following fields:
  img_raw: string containing JPEG encoded image in RGB colorspace
...
tf.app.flags.DEFINE_string('output_directory', 'converted_data/',
...
def _find_image_files(data_dir, labels_file):
  ...
  for text in unique_labels:
    ...
    # The Glob function is deprecated so the line below does not work anymore.
